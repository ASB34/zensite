...
export default function TinyLiving() {
  const specs = [
    { icon: <Layers className="w-4 h-4 text-cyan-400" />, label: 'Integration', value: 'Seamless Edge-to-Edge' },
    { icon: <Droplets className="w-4 h-4 text-cyan-400" />, label: 'Sink Module', value: 'High-Grade Titanium Finish' },
    { icon: <Zap className="w-4 h-4 text-cyan-400" />, label: 'Power Draw', value: 'Optimized for Off-Grid (12V/220V)' },
    { icon: <Ruler className="w-4 h-4 text-cyan-400" />, label: 'Dimensions', value: 'Compact: 80cm x 40cm' },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col py-12 px-6 md:px-12 relative">
      ...
      <div className="max-w-7xl mx-auto w-full z-10">
        ...
        >
          <span className="text-cyan-400 text-[10px] uppercase font-bold tracking-widest px-3 py-1 bg-cyan-400/10 border border-cyan-400/20 rounded-full">Special Edition</span>
        </motion.div>
        ...
        >
          Zen<span className="font-medium">Nomad</span> Module
        </motion.h1>
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-2xl bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center group">
             ...
             <div className="relative w-3/4 h-1/3 bg-white/5 border border-white/20 rounded-xl flex preserve-3d shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform -rotate-12 hover:rotate-0 transition-transform duration-700 ease-out">
                ...
                <div className="w-1/2 h-full border-r border-white/10 relative flex items-center justify-center overflow-hidden">
                   <div className="absolute top-4 left-4 text-[8px] text-cyan-400 uppercase tracking-widest opacity-60">Induction Zone</div>
                ...
                <div className="w-1/2 h-full relative p-4 flex items-center justify-center bg-white/5">
                   <div className="absolute top-4 left-4 text-[8px] text-gray-400 uppercase tracking-widest opacity-60">Sink Basin</div>
             ...
             <div className="absolute bottom-6 left-6 right-6 flex justify-between text-[10px] uppercase tracking-widest text-white/40">
               ...
               <span>Nomadic Kitchen</span>
             </div>
          </div>

          {/* Copy and Specs */}
          <div className="flex flex-col">
            <h3 className="text-2xl font-light mb-4">Complete Kitchen, Zero Footprint</h3>
            <p className="text-sm opacity-60 font-light leading-relaxed mb-8">
              Designed explicitly for Tiny Houses and modern Caravans. The ZenNomad module combines our invisible induction technology with a high-grade concealed sink in a single, plug-and-play surface. Pre-wired, pre-plumbed, and ready to drop into any compact counter space.
            </p>
